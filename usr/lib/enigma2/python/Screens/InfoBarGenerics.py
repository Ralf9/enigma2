...
class InfoBarSubserviceSelection:
	...
	def subserviceSelection(self):
		...
		if n and n > 0:
			...
			self.session.openWithCallback(self.subserviceSelected, ChoiceBox, title=_("Please select a subservice..."), list = tlist, selection = selection, keys = keys, skin_name = "SubserviceSelection", windowTitle=_("Subservices"))
